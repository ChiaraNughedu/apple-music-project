...
import { Navbar, Nav, Offcanvas, Container, Row, Col, Form } from "react-bootstrap";
  ...
  return (
    <>
      ...
      <Container fluid={true}>
        <Row>
          <Col lg={2} className="d-none d-lg-block bg-dark sidebar min-vh-100">
          ...
          <Col lg={10} className="ms-lg-auto p-4">
            <Novità />
          </Col>
        </Row>
      </Container>
